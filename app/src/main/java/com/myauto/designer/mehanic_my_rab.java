...
public class mehanic_my_rab extends AppCompatActivity {
    ...
    ArrayList<DataModelMehanicMyRab> dataModelMehanicMyRabs;
    ListView listView;
    private static CustomAdapterMehanicMyRab adapter;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_mehanic_my_rab);
        ...
        listView = (ListView)findViewById(R.id.mehanic_my_rab_listview);
    ...
    private class getMehanicRabot extends AsyncTask<Void, Void, Void> {
        ...
        protected void onPreExecute() {
            super.onPreExecute();
            progressDialog = new ProgressDialog(mehanic_my_rab.this);
        ...
        protected Void doInBackground(Void... voids) {
            ...
            try {
                dataModelMehanicMyRabs = new ArrayList<>();
                ...
                if (empty.equals("no")){
                    ...
                    for (int i = 0; i < jsonArray.length(); i++) { // Цикл где в стринг result пришло от баз
                        ...
                        runOnUiThread(new Runnable() {
                            @Override
                            public void run() {
                                dataModelMehanicMyRabs.add(new DataModelMehanicMyRab(raboper));
                                adapter= new CustomAdapterMehanicMyRab(dataModelMehanicMyRabs,getApplicationContext());
    ...
    private class getMyRab extends Thread {
        ...
        public void run() {
            ...
            try {
                ...
                HttpPost httpPost = new HttpPost("http://"+IPSTRING+"/oleg/mobile/test/getMyRabOper.php");
            ...
            try {
                ...
                if (empty.equals("no")){
                   ...
                   runOnUiThread(new Runnable() {
                       @Override
                       public void run() {
                           AlertDialog.Builder builder = new AlertDialog.Builder(mehanic_my_rab.this);
