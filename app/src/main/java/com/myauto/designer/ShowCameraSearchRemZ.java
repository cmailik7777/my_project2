...
public class ShowCameraSearchRemZ extends ActionBarActivity {
    ...
    Button cancelCamSearchRemz, goodCamSearchRemz;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_show_camera_search_rem_z);
        Toolbar toolbar = (Toolbar) findViewById(R.id.toolbar);
        setSupportActionBar(toolbar);
        setRequestedOrientation(ActivityInfo.SCREEN_ORIENTATION_PORTRAIT);

        cameraPreviewLayout = (FrameLayout) findViewById(R.id.camera_previewSearchRemz);
        capturedImageHolder = (ImageView) findViewById(R.id.captured_imageSearchRemz);

        cancelCamSearchRemz = (Button) findViewById(R.id.cancelCamSearchRemz);
        goodCamSearchRemz = (Button) findViewById(R.id.goodCamSearchRemz);


        camera = checkDeviceCamera();
        mImageSurfaceView = new ImageSurfaceView(ShowCameraSearchRemZ.this, camera);
        cameraPreviewLayout.addView(mImageSurfaceView);


        Button captureButton = (Button) findViewById(R.id.buttonSearchRemz);
        captureButton.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {

                cancelCamSearchRemz.setVisibility(View.VISIBLE);
                goodCamSearchRemz.setVisibility(View.VISIBLE);

                progressdialog1 = new ProgressDialog(ShowCameraSearchRemZ.this);
                progressdialog1.setMessage("Пожалуйста подождите...");
                ...
                builder.setTitle("Подтверждение")
                        .setMessage("Вы действительно хотите отправить фотографию на сервер?")
                        .setCancelable(false)
        ...
        goodCamSearchRemz.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
                progressdialog = new ProgressDialog(ShowCameraSearchRemZ.this);
                ...
                new Thread(new Runnable() {
                    ...
                    public void run() {
                        ...
                        runOnUiThread(new Runnable() {
                            @Override
                            public void run() {
                                //Toast.makeText(ShowCameraSearchRemZ.this, resResult, Toast.LENGTH_LONG).show();
                            }
                        });
                        progressdialog.dismiss();
                        //--------------------------------------------------------------------------------------------------------------------------------------------
                        Intent intentV = new Intent(ShowCameraSearchRemZ.this, ListRemZ.class);
                        intentV.putExtra("GOSCAMREMZ", resResult);
        ...
        cancelCamSearchRemz.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
                finish();
            }
