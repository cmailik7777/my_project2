...
public class Show_Cam_Mehanic extends ActionBarActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_show__cam__mehanic);
        ...
        mImageSurfaceView = new ImageSurfaceView(Show_Cam_Mehanic.this, camera);
        ...
        goodCam.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                runOnUiThread(new Runnable() {
                    @Override
                    public void run() {
                        progressdialog = new ProgressDialog(Show_Cam_Mehanic.this);
                        ...
                        runOnUiThread(new Runnable() {
                            ...
                            public void run() {
                                if (resResult.contains("BN")){
                                    AlertDialog.Builder builder = new AlertDialog.Builder(Show_Cam_Mehanic.this);
                                    ...
                                    builder.setTitle("Окно предупреждения!")
                                            ...
                                            .setNegativeButton("да",
                                                    new DialogInterface.OnClickListener() {
                                                        public void onClick(DialogInterface dialog, int id) {
                                                            Intent intentV = new Intent(Show_Cam_Mehanic.this, rzMehanic.class);
